...
export default function Admin(){
    ...
    function createProduct(e){
        ...
        fetch("https://domingo-capstone2.herokuapp.com/product/create-product",{
            method: "POST",
            headers: {
    ...
    useEffect(() => {
        ...
        fetch('https://domingo-capstone2.herokuapp.com/product/inactive-products', {
            method: "GET"
        })
        .then(response => response.json())
        .then(data => {
    ...
    const searchProduct = async () => {
       ...
       if(productID !== ""){
            await fetch('https://domingo-capstone2.herokuapp.com/product/get-product', {
            method: "POST",
            headers:{
                "Content-Type": "application/json"
            },
    ...
    const updateProductButton = (e) => {
        ...
        if(productID !== "" && updateName !== "" && updateDesc !== "" && updatePrice !== "" && updateBrand !== "" && updateCategory !== "" && updateBranch !== "" && updateImageURL !== "" ){
            fetch('https://domingo-capstone2.herokuapp.com/product/update-product', {
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const archiveButton = () => {
        ...
        if(productID !== ""){
            fetch("https://domingo-capstone2.herokuapp.com/product/archive-products",{
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const activateButton = () => {
        ...
        if(productID !== ""){
            fetch("https://domingo-capstone2.herokuapp.com/product/activate-products",{
            method: "PUT",
            headers: {
                "Content-Type": "application/json"
            },
    ...
    const deleteButton = () => {
        ...
        if(productID !== ""){
            fetch("https://domingo-capstone2.herokuapp.com/product/delete-products",{
            method: "DELETE",
            headers: {
                "Content-Type": "application/json"
            },
